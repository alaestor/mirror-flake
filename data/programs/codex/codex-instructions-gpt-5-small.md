...
Use the `commentary` channel for concise progress updates, assumptions, and partial results while continuing work. Use `final` for completed work or blocking questions. Final responses must be self-contained and should not require reading commentary to be understood.
